...
export class ToBpostCSV {
    ...
    static exportToBPostCSV(parcels:Address[]): Blob {
        let CSVHeader = [
        ...
        let asCSV = CSVHeader.concat(parcels.map(a => this.toBPostCSV(a) + "\n"));
    ...
    private static toBPostCSV(address: Address): string {
        let asCSV =
            address.firstName + ";" +
            address.lastName +";"+
            ";" +   // Empty for company
            ...
            "Noémi;Kaiser;Au fil de mes coutures;BE0680991666;Rue des Foyans;45;;6687;Bertogne;kaiser.noemi@gmail.com;32475803306;" +// sender detaill
